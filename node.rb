...
SETTINGS = {
  :url          => "https://3d6e4e81a2a8.hsd1.ca.comcast.net",  # e.g. https://foreman.example.com
  ...
  :ssl_cert     => "/var/lib/puppet/ssl/certs/3d6e4e81a2a8.hsd1.ca.comcast.net.pem",    # e.g. /var/lib/puppet/ssl/certs/FQDN.pem
  :ssl_key      => "/var/lib/puppet/ssl/private_keys/3d6e4e81a2a8.hsd1.ca.comcast.net.pem"      # e.g. /var/lib/puppet/ssl/private_keys/FQDN.pem
}
